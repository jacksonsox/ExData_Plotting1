---
title: "Coursera - Class 4 - Week 1 - Assignment - Plot 3"
...
Create a graph of Energy sub metering vs. time showing the day with a legend
```{r plot1, eval=TRUE}
...
legend("topright", lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), type)
