---
title: "Coursera - Class 4 - Week 1 - Assignment - Plot 2"
...
Create a graph of Global active power (kWatts) over time showing the day
```{r plot1, eval=TRUE}
png(file = "plot2.png", width = 480, height = 480)
plot(x = housePowerConsume2Day$DateTime, y = housePowerConsume2Day$Global_active_power, type = "line", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()
```